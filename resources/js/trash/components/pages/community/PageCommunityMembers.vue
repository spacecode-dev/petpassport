    ...
    <div class="cn-main">
        ...
        <div class="cn-main--content">
            ...
            <div class="grid grid--three grid--gap">
                <div class="e-do" :class="{ 'e-do--static': !can_edit }" v-for="user in members">
...
export default {
    ...
    computed: {
        ...
        can_edit() {
            return this.community.user_role && this.community.user_role <= 2;
        },
        hasMore() {
    ...
    methods: {
        async load() {
            ...
            const data = (await axios.get('/api/community_members', {
                params: {

...
return [
    ...
    */
    ...
    'announcements_pet_id' => 'Недопустимое действите с текущим питомцем',
    ...
    */
    ...
    'attributes' => [
        ...
        'max' => 'Максимум',
        'min' => 'Минимум',
        'wallet_qr_code' => 'QR-код кошелька',
        'signature' => 'Сигнатура',
        'wallet_text' => 'Дополнительный текст',
        'name input wallet' => 'Заголовок поля',
        'placeholder_input_wallet' => 'Подпись поля',
        'wallet' => 'Кошелёк',
        'currency_id' => 'Валюта',
        'status_id' => 'Статус',
        'from_payment_method_id' => '"От"',
        'to_payment_method_id' => '"Кому"',
        'currency_id_buy' => 'Покупка',
        'currency_id_sell' => 'Продажа',
        'value_to' => 'Получает',
        'value_from' => 'Отдаёт',
        'comment' => 'Комментарий',
        'rate' => 'Курс обмена',
        'exchange_site_id' => 'Обменник',
